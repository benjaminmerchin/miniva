    ...
    <section className="relative z-10 mx-auto max-w-6xl px-6 pb-16 pt-16">
      ...
      >
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="group mt-3 inline-flex items-center gap-2 rounded-lg border border-line bg-panel px-3.5 py-2 text-[13px] text-muted transition-colors hover:border-blurple/50 hover:text-fg"
        >
          <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" className="text-blurple-soft">
          ...
          See it live — join the demo Discord
